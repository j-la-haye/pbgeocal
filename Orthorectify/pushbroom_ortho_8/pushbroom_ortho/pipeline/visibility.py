...
class VisibilityChecker:
    ...
    def __init__(self, dsm: DSMHandler, config: VisibilityConfig):
        ...
        # Transformer: ECEF → DSM native CRS (for sensor position)
        # Must use a 3D-capable CRS to preserve height in the transform.
        # For geographic DSMs (e.g. EPSG:4979), this returns (lon, lat, h).
        # For projected DSMs (e.g. UTM), this returns (easting, northing, h).
        dsm_crs_3d = CRS.from_epsg(dsm.dsm_epsg)
