...
class TimeSolver:
    ...
    def _compute_residual(self, t: np.ndarray,
        ...
        u_pixel = self.cam.project(d_cam)

        # Along-track residual: Y_obs − (kf · Y_lab(u) − δy)
    ...
    def solve(self, ground_ecef: np.ndarray,
        ...
        u_pixel  : (M,) across-track pixel coordinates (LUT indices)
        ...
        return t, u_pixel, line_idx, valid
